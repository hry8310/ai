...
def synthesis(text, args):
    ...
    with t.no_grad():
        for i in pbar:
            pos_mel = t.arange(1,mel_input.size(1)+1).unsqueeze(0).to(dev)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--restore_step1', type=int, help='Global step to restore checkpoint', default=50)
    parser.add_argument('--restore_step2', type=int, help='Global step to restore checkpoint', default=150)
